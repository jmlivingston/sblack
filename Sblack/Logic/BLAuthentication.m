...
+ (void)postAlert:(NSNotification *)aAlert
{
    ...
    alert.messageText = @"Your Password is Needed";
    alert.informativeText = @"To apply the theme your password is needed. Learn why below.";
    ...
    if (res == NSAlertFirstButtonReturn) {
        [NSWorkspace.sharedWorkspace openURL:[NSURL URLWithString:@"https://github.com/frankdilo/sblack/wiki/Why-does-Sblack-need-my-password%3F"]];
    }
}
